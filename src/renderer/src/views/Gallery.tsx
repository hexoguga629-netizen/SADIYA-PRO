  ...
  return (
    <div className="flex-1 bg-white/8 h-full p-8 animate-in fade-in zoom-in duration-500 flex flex-col overflow-hidden">
      <div className="flex items-center justify-between pb-6 border-b border-white/5 mb-6 shrink-0">
        ...
        <div className="text-[10px] font-mono text-green-300 bg-green-500/10 px-3 py-1.5 rounded border border-green-500/20 s
            ...
            {visibleImages.map((img, index) => {
              ...
              return (
                <div
                  ...
                  className="group relative aspect-16/10 bg-zinc-900/50 rounded-xl border border-white/5 overflow-hidden hove
                >
                  <img
                    src={img.url}
                    alt={img.displayName}
                  ...
                  <div className="absolute inset-0 bg-linear-to-t from-black via-black/40 to-transparent opacity-0 group-hove
                    ...
                    <div className="flex gap-2 justify-end">
                      <button
                        ...
                        className="p-2 bg-white/10 text-white rounded-lg hover:bg-blue-600 hover:text-white transition-all ba
                      ...
                      <button
                        ...
                        className="p-2 bg-white/10 text-white rounded-lg hover:bg-red-600 hover:text-white transition-all bac
                        title="Delete Image"
                      >
        ...
        {selectedImage && (
          ...
          >
            <button
              ...
              className="cursor-pointer absolute top-6 right-6 p-3 bg-white/5 hover:bg-red-500/20 hover:text-red-400 rounded-
            >
              <RiCloseLine size={24} />
            </button>

            <div
              className="absolute left-0 top-0 bottom-0 w-32 z-40 flex items-center justify-start pl-6 group cursor-pointer h
              onClick={() => navigateImage(-1)}
            >
              <div className="p-4 bg-white/5 group-hover:bg-green-500/20 text-zinc-400 group-hover:text-green-400 rounded-ful
                <RiArrowLeftSLine size={32} />
              </div>
            </div>

            <div
              className="absolute right-0 top-0 bottom-0 w-32 z-40 flex items-center justify-end pr-6 group cursor-pointer ho
              onClick={() => navigateImage(1)}
            >
              <div className="p-4 bg-white/5 group-hover:bg-green-500/20 text-zinc-400 group-hover:text-green-400 rounded-ful
              ...
              <div className="relative w-full max-w-7xl h-[75vh] flex items-center justify-center">
                <AnimatePresence initial={false} custom={direction} mode="popLayout">
                  <motion.img
                    ...
                    className="absolute max-w-full max-h-full rounded-lg shadow-[0_0_100px_rgba(0,0,0,0.8)] border border-whi
                  />
                </AnimatePresence>
              </div>
              ...
              <div className="absolute bottom-10 z-50 flex flex-col items-center gap-6">
                ...
                <div className="flex gap-4">
                  <motion.button
                    ...
                    className="cursor-pointer flex items-center gap-2 px-6 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-200
                  >
                  ...
                  <motion.button
                    ...
                    className="cursor-pointer flex items-center gap-2 px-6 py-2.5 bg-blue-900/20 hover:bg-blue-600 text-blue-
                  >
                  ...
                  <motion.button
                    ...
                    className="cursor-pointer flex items-center gap-2 px-6 py-2.5 bg-red-900/20 hover:bg-red-600 text-red-200
                  >
