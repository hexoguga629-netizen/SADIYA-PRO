...
export default function LiveCodingWidget() {
  ...
  return (
    <div className="absolute inset-0 z-999 flex items-center justify-center bg-black/60 backdrop-blur-sm p-10">
      <div className="w-full max-w-4xl h-[70vh] flex flex-col bg-[#0a0a0a] border border-emerald-500/30 rounded-xl shadow-[0_
          ...
          <div className="flex items-center gap-3">
            {!isGenerating && filePath && (
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emeral
              >
